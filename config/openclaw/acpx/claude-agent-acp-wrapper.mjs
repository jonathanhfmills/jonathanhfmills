...
const installedBinPath = "/home/openclaw/.openclaw/npm/projects/openclaw-acpx-052d680d6d/node_modules/@openclaw/acpx/node_modules/@agentclientprotocol/claude-agent-acp/dist/index.js";
let defaultCommand;
let defaultArgs;
if (installedBinPath) {
  ...
  defaultCommand = process.execPath;
  defaultArgs = [npmCliPath, "exec", "--yes", "--package", "@agentclientprotocol/claude-agent-acp@0.55.0", "--", "claude-agent-acp"];
} else {
  defaultCommand = process.platform === "win32" ? "npx.cmd" : "npx";
  defaultArgs = ["--yes", "--package", "@agentclientprotocol/claude-agent-acp@0.55.0", "--", "claude-agent-acp"];
}
const command =
